export const EVOLUTION = {
  ...
  LEVEL: 'LEVEL',
  // levels up whilst knowing specific move
  LEVEL_MOVE: 'MOVE',
  // Pokemon is traded
  TRADE: 'TRADE',
  ...
  ITEM: 'ITEM',
  // specified item needs to be used on male Pokemon
  ITEM_MALE: 'ITEM_MALE',
  // specified item needs to be used on female Pokemon
  ITEM_FEMALE: 'ITEM_FEMALE',
  // specified item needs to be used on Pokemon at a specific time
  ITEM_DAY: 'ITEM_DAY',
  // specified item needs to be used on Pokemon at a specific time
  ITEM_NIGHT: 'ITEM_NIGHT',
  // levels up whilst in named area
  LEVEL_AREA: 'AREA',
  // evolves when level is met and male
  LEVEL_MALE: 'LEVEL_MALE',
  // evolves when level is met and female
