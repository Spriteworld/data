...
export const WEAKNESS = {
  ...
  [definitions.ICE]: [definitions.FIRE, definitions.WATER, definitions.ICE],
  ...
  [definitions.PSYCHIC]: [definitions.PSYCHIC],
  [definitions.BUG]: [definitions.FIRE, definitions.FIGHTING, definitions.POISON, definitions.FLYING, definitions.GHOST],
...
export const STRENGTH = {
  ...
  [definitions.BUG]: [definitions.GRASS, definitions.PSYCHIC],
